...
The "UR Robot Point Programming" experience can be downloaded [here](). The associated ThingWorx and Kepware components can be downloaded [here]() and [here](https://github.com/jtfrandsen/Gaze-Tracking-Demos/blob/15570cecc65596bc56a05cc558b0a9cc88c22fa7/AR%20Experience%20Files/UR.Robot.GitHub.opf), respectively.
